...
def cmd_arb(args, _main_cfg):
    ...
    if args.run or args.dry_run:
        ...
        console.print("[yellow]Backtest mode not yet implemented (Plan B)[/yellow]")
    elif args.download_data:
        console.print("[yellow]Download data not yet implemented (Plan B)[/yellow]")
    elif args.report:
        console.print("[yellow]Report not yet implemented (Plan B)[/yellow]")
    elif args.backtest_report:
        console.print("[yellow]Backtest report not yet implemented (Plan B)[/yellow]")
    else:
        console.print("[yellow]請指定模式: --run / --dry-run / --backtest / --report[/yellow]")
